...
<body style="background-image:url('images/loginback.jpg');background-size:cover">
	...
	<form class="myform" action="login.php" method="post" name="loginForm">
		...
		<center><br><input type="submit" name="login" id="login_btn" value="Login"  /><br><!--onclick="myFunction(document.loginForm.username)"-->
		<a href="register.php" style="text-decoration:none"><input type="button" id="register_btn" value="Register"/><a/><br>
